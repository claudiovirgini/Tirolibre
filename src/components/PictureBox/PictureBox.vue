<template>
   <img :src="picUrl"   v-bind:class="{ 'imgDefaultPlayer': isDefaultPlayer,'imgDefaultTeam':isDefaulTeam,'imgDefaultCardPlayer':isDefaulCardPlayer  }"  @error="imageLoadError"/>
</template>
...
.imgDefaultTeam { content: url("../../assets/img/vue-logo.png"); }
</style>
